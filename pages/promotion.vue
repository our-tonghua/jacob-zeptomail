      ...
      <div class="promotion-top">
        <v-row>
          <v-col md="8" offset-md="2" class="text-center">
            ...
            <p class="mt-4">
              We have the lowest pricing in Washington state, and we have
              strategically set up our internal systems to cut costs and leave
              clients with the best rates they need. Fill out the form below to
              upload your recent estimate and enjoy our superb electrical
              ...
              <div class="promotion-form">
                <v-form>
                  <v-row>
                      ...
                      >
                        <div class="dropzone-custom-content">
                          ...
                          <h3 class="dropzone-custom-title">
                            Drag and drop to upload quotation!
                          </h3>
                          <div class="subtitle">
                    ...
                    <v-col cols="12">
                      ...
                      >
                        <div class="dropzone-custom-content">
                          ...
                          >
                          <h3 class="dropzone-custom-title">
                            Drag and drop to upload photography!
                          </h3>
                          <div class="subtitle">
                            ...or click to select a file from your computer
                          </div>
                    ...
                    <v-col cols="12">
                      <label
                        >Would you like to share your budget? Optional</label
                      >
                      <v-row>
                        <v-col cols="6">
                          <ValidationProvider
  ...
  head: {
    ...
    meta: [
      ...
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        ...
        name: "description",
        content:
          "Wondering how to start a small electrical contractor business in Washington? You don't have" +
      ...
      },
      {
        ...
        name: "keywords",
        content:
          'how to start a small electrical contractor business, electrical business opportunities, how to start an electrical contracting business"\ny'
      }
    ]
  },
  components: {
