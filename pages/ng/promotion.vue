      ...
      <div class="promotion-top">
        <v-row>
          <v-col md="8" offset-md="2" class="text-center">
            ...
            <p class="mt-4">
              We have the Fairest pricing in Nigeria, and we have strategically set up our internal systems to cut costs
              and leave clients with the best rates they need. Fill out the form below to upload your recent quotation
              that you received from other client and let us beat the price for you.
            </p>
          </v-col>
        </v-row>
      </div>
